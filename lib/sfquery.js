 ...
 * @param {function} process_function - process_function(sf_object, object_name, for_time, query, result) callback.
 */
    ...
    conn.query(q, function(err, result) {
        if (err) {
            ...
            if (typeof (process_function) == 'function') {
                process_function(sf_object, object_name, for_time, q, result);
            } 
        }
    });
}
